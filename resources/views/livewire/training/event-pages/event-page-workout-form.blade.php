<div class="min-h-full">
    <x-form wire:submit.prevent="submitForm" action="/training/event-pages/workouts">
        ...
        <x-input.group for="workout_date_for_editing" label="Workout Date" :error="$errors->first('workout_date_for_editing')">
            <x-input.date
