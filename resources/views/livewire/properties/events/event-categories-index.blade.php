            ...
            <x-slot name="body">
                @forelse($categories as $category)
                    ...
                    >
                        ...
                        <x-table.cell class="w-1/12 flex justify-end lg:px-2">
                            <x-dropdown.dropdown>
                                ...
                                <x-slot name="content">
                                    <x-dropdown.link wire:click="editRecord({{ $category->id }})">
                                        Edit
                                    </x-dropdown.link>
                    ...
                    <x-modal.confirmation wire:model.defer="showConfirmModal">
                        ...
                        <x-slot name="content">Are you sure you want to delete this category? This cannot be
                            undone.
                        </x-slot>
                        <x-slot name="footer">
                            ...
                            <x-button.danger wire:click="destroy({{ $category->id }})">
                                Yes, Delete Category
                            </x-button.danger>
                        </x-slot>
    ...
    <x-modal.dialog wire:model.defer="showFormModal">
        <x-slot name="title">
            <div x-data="{editing: @entangle('editing')}">
                <span x-show="editing === true">Edit Category</span>
                <span x-show="editing === false">Add a Category</span>
            </div>

        </x-slot>

        <x-slot name="content">
            <livewire:properties.events.event-category-form />
        </x-slot>
