<div>
                    ...
                    <x-table.cell class="w-1/12 flex justify-end">
                        @can('coach')
                            <x-dropdown.dropdown>
                                ...
                                <x-slot name="content">
                                    <x-dropdown.link wire:click="edit({{ $workout->id }})">
                                        Edit
                                    </x-dropdown.link>
                                    <x-dropdown.link wire:click="confirmDelete({{ $workout->id }})">
                                        Delete
                                    </x-dropdown.link>
                                </x-slot>
                            </x-dropdown.dropdown>
    ...
    <x-modal.add-edit-record record-title="Workout">
        <livewire:training.event-pages.event-page-workout-form :eventSubtype="$eventSubtype" />
