...
class CreateTfMeetRelayEventResultsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tf_meet_relay_event_results', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tf_meet_relay_event_results');
    }
}
